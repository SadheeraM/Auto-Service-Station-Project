...
<html lang="en">
 ...
 <head>
   <title>J.H.S Service station</title>
    ...
    <!-- HEADER -->
        ...
        <section class="grid margin-bottom-20">
          <div class="m-12 l-7 center">
            ...
            <div class="s-12 padding-2x background-white text-center">                  
              ...
              <p>KOPIWATTA</p>
              <p>PALLEBEDDA, SRI LANKA</p>             

              <h2 class="text-size-20 margin-top-30 margin-bottom-10 text-strong text-uppercase text-dark">E-mail</h2>                
              <p><a class="text-primary-hover" href="mailto:contact@sampledomain.com">xxx@gmail.com</a></p>
              <p><a class="text-primary-hover" href="mailto:office@sampledomain.com">xxx@gmail.com</a></p>               
      ...
      <footer class="grid">
        ...
        <div class="s-12 m-9 l-3 padding-2x margin-bottom background-dark">
           ...
           <p><b class="text-primary margin-right-10">P</b> 045-22XXXXX</p>
           <p><b class="text-primary margin-right-10">M</b> <a class="text-primary-hover" href="mailto:contact@sampledomain.com">xxx@gmail.com</a></p>
           <p><b class="text-primary margin-right-10">M</b> <a class="text-primary-hover" href="mailto:office@sampledomain.com">xxx@gmail.com</a></p>
        </div>
