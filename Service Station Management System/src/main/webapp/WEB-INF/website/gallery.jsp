	...
	<body class="size-1520 primary-color-red background-dark">
      ...
      <main role="main">
        ...
        <header class="grid">
            ...
            <h1 class="text-strong text-white text-center center text-size-60 text-uppercase margin-bottom-20">Our Location</h1>
            <p class="text-size-20 text-white text-center center text-uppercase">Our premises are located in a quiet and quiet place. You can enjoy the beauty of the surrounding area while we service your vehicles. 
            We protect the environment</p>
          </div>
        </header>
      
        <section class="grid margin">
          <img class="s-12 m-6 margin-bottom" src="img/portfolio/OTEK_img.jpg" alt=""/>
          <img class="s-12 m-6 margin-bottom" src="img/portfolio/OTEK_img2.jpg" alt=""/>
        ...
        <section class="grid">
           ...
           <iframe scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=1439&amp;height=575&amp;hl=en&amp;q=%20Oteck%20Auto%20Service%20Station+()&amp;t=k&amp;z=13&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="1439" height="575" frameborder="0">
           </iframe> <a href='http://maps-generator.com/'>google map at hp</a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=5d460af3b755d3fe1d15f951f80634410fcef82e'>
           </script>
