    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<a href="/addNewServices" class="btn btn-info">Add New Services</a>
				...
				<div class="page">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							<table id="table_service_list" class="table">
...
$(document).ready(listAllServices);
function listAllServices(){
    
	$.ajax({
        url: '/findAllServiceAndItems?theType=ITEM',
        type: 'post',
        data:{},
        success: function (data) {
            ...
            $("#table_service_list").html(row);
			$('#table_service_list').DataTable({
			    destroy: true,
