...
<body>
        ...
        <div class="page-wrapper" >
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Stock Control</h4>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Stock Control</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-7"><a href="/stock_in_form" id="">
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-7"><a href="/stock_out_list" id="">
                        <div class="card card-hover">
                    ...
                    <!-- 
                    <div class="col-md-6 col-lg-4 col-xlg-7"><a href="" id="">
                        <div class="card card-hover">
                            <div class="box bg-secondary text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i></h1>
                                <h6 class="text-white">Stock Return</h6>
                            </div>
                        </div></a>
                    </div>
                     -->
                    
                    <div class="col-md-6 col-lg-4 col-xlg-7"><a href="/stock_in_history" id="">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i></h1>
                                <h6 class="text-white">Stock In History</h6>
                            </div>
                        </div></a>
                    </div>
                    
                    
                    <div class="col-md-6 col-lg-4 col-xlg-7"><a href="/stock_out_history" id="">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i></h1>
                                <h6 class="text-white">Stock Out History</h6>
                            </div>
                        </div></a>
                    </div>
                    
                    
                    <div class="col-md-6 col-lg-4 col-xlg-7"><a href="/stock_level" id="">
                        <div class="card card-hover">
                            <div class="box bg-primary text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i></h1>
                                <h6 class="text-white">Stock Level</h6>
                            </div>
                        </div></a>
                    </div>
	...
	if (sessionName == 'manager') {
		...
		$('#jobcard_session, #jobcard_session2').click(function (e) {
        	e.preventDefault();
        	swal("Access Denied!", "You have no permission !", "warning");
    	});


    	$('#empReg_session').click(function (e) {
        	e.preventDefault();
        	swal("Access Denied!", "You have no permission !", "warning");
    	});

    	$('#EmpAtt_session').click(function (e) {
        	e.preventDefault();
        	swal("Access Denied!", "You have no permission !", "warning");
    	});

    	$('#EmpSal_session').click(function (e) {
        	e.preventDefault();
        	swal("Access Denied!", "You have no permission !", "warning");
    	});
