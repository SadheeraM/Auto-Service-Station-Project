...
<script src="../../proccss_jobs_main.js"></script>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">List of Processing Jobs</h4>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Processing Jobs</li>
				...
				<div class="page">
					<div class="card-body">
						...
						<div class="table-responsive"  id="page">
							...
							<table id="table_proccs_jobs" class="table table-hover table-dark">
