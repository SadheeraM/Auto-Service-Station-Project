                            ...
                            <div>
                               ...
                               <h3>Profile Part I</h3>
                                <section>
                                    ...
                                    <input id="empFname" name="empFname" type="text" class="form-control" placeholder="Enter employee's first name" value="${employee.empFname}">
                                    
                                    
                                    <label for="">Last name *</label> <span class="error_form" id="empLname_error_message"></span>
                                    <input id="empLname" name="empLname" type="text" class="form-control" placeholder="Enter employee's last name" value="${employee.empLname}">
                                    
                                    <label for="">Address *</label> <span class="error_form" id="empAddrss_error_message"></span>
                                    <input id="empAddrss" name="empAddrss" type="text" class="form-control" placeholder="Enter emplyee's current address" value="${employee.empAddrss}">
                                    ...
                                    <input id="empNIC" name="empNIC" type="text" class="form-control" placeholder="Enter employee's National Identity Card Number !" value="${employee.empNIC}">
                                    
                                    <label for="">Date of Birth *</label> <span class="error_form" id="empDOB_error_message"></span>
                                    <input id="empDOB" name="empDOB" type="text" class="form-control" placeholder="19XX/XX/XX" value="${employee.empDOB}">
                                ...
                                <section>
                                    ...
                                    <label for="">Type of Job *</label> <span class="error_form" id="empTypeJob_error_message"></span>
                                     ...
                                     <div class="form-control">
                                        <select id="empTypeJob" name="empTypeJob" class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                            	...
                                            	<option value="${employee.empTypeJob}" disabled selected hidden >${employee.empTypeJob}</option>
                                    ...
                                    <input id="empJobStDate" name="empJobStDate" type="text" class="form-control" placeholder="Enter employee's job start date" value="${employee.empJobStDate}">
                                    
                                    
                                    
                                    <label for="">Contact No *</label> <span class="error_form" id="empContNo_error_message"></span>
                                    <input id="empContNo" name="empContNo" type="text" class="form-control" placeholder="Enter employee's contact number" value="${employee.empContNo}">
                                    
                                    <label for="">Work Experience</label> <span class="error_form" id="empWkExp_error_message"></span>
                                    <textarea rows="3" id="empWkExp" name="empWkExp" class="form-control" placeholder="Enter employee's work experiences ...">${employee.empWkExp}</textarea>
                                    
                                    <label for="">Educational Qualifications</label> <span class="error_form" id="empEduQualfi_error_message"></span>
                                    <textarea rows="3" id="empEduQualfi" name="empEduQualfi" class="form-control" placeholder="Enter employee's educational qualifications ...">${employee.empAddInfo}</textarea>
                                    
                                    <label for="">Email</label> <span class="error_form" id="empEmail_error_message"></span>
                                    <input id="empEmail" name="empEmail" type="text" class="form-control" value="${employee.empEmail}">
                                    
                                    <label for="">Additional Information</label> <span class="error_form" id="empAddInfo_error_message"></span>
                                    
                                    <textarea rows="3" id="empAddInfo" name="empAddInfo" class="form-control" placeholder="Enter employee's additional information (e.g: Health condition etc...)">${employee.empAddInfo}</textarea>
