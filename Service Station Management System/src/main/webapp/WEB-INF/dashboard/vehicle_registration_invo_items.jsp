            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Service History -<span class="page-title2"></span></h4>
				...
				<div class="page">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							<table id="table_vehicle_invo_items" class="table">
								
							</table>
							
							<div class="card-body">
                                
 							<a href="/vehicle_registration" class="btn btn-secondary" id="">&nbspBack&nbsp</a>
...
$(document).ready(listAllVehiclesInvoItems);
function listAllVehiclesInvoItems(){

	var session_vehicle_no = localStorage.getItem("session_vehicleNo");


	$('.page-title2').append(session_vehicle_no);

	var vehicle_no1 = session_vehicle_no;
    
	$.ajax({
        url: '/listAllVehiclesInvoiceItems?theVehicleNo='+vehicle_no1+'',
        type: 'get',
        data:{},
        success: function (data) {
            ...
            $("#table_vehicle_invo_items").html(row);
			$('#table_vehicle_invo_items').DataTable({
			    destroy: true,
