...
<script src="../../invoice_main2.js"></script>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12" id="printDiv">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="pull-right text-right">
                                        <address>
                                            ...
                                            <h4 class="font-bold vehNO">VEHICLE NO - </h4>
                                            <span class="text-muted m-l-30">NEXT SERVICE - </span>
                                            <span id="next_km"></span>
                                             ...
                                             <br/>
                                              ...
                                              function cal_next_km(){

												var currentKM = $('#current_km').val();

												var no_of_KM = parseInt(currentKM);

												$('#next_km').empty();
												$('#next_km').append(no_of_KM + 10000 +" KM");

												
												$('#nextService').val(no_of_KM+" KM");
												

												var abc = $('#current_km').val();	
												$('#currentMeter').val(abc);
                                            ...
                                            <script type="text/javascript">
												...
												$('.invoice_date').append(invoiceDate);
                        ...
                        <input type="hidden" id="invoDate" name="invoDate" class="form-control" placeholder="invo_date">
							...
							<div class="card-body">
 							...
 							<div class="row mb-3 align-items-left">
                                    ...
                                    <div class="col-lg-3 col-md-12">
                                        <input type="text" class="form-control" id="current_km" name="current_km" placeholder="Type Current Meter">
