        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <!-- Column -->
                    <div class="col-md-6 col-lg-4 col-xlg-7"><a href="/deleted_bookings" id="">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i></h1>
                                <h6 class="text-white">Deleted Bookings</h6>
                            </div>
                        </div></a>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-4 col-xlg-7"><a href="/deleted_bookings_unaccepted" id="">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i></h1>
                                <h6 class="text-white">Deleted Inbox</h6>
                            </div>
                        </div></a>
                    </div>
                    
                  	<div class="col-md-6 col-lg-4 col-xlg-7"><a href="/all_services_list" id="">
                        <div class="card card-hover">
