            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Stock Out Report</h4>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Stock Out Report</li>
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <button type="button" class="btn btn-success" onclick="listStockOutList()">Generate</button>
				...
				<div class="page">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							<table id="table_stock_out_list" class="table">
...
function listStockOutList(){
	...
	$.ajax({
        url: '/findAllSellingStockItems?theDate1='+fromDate+'&theDate2='+toDate+'',
        type: 'get',
        data:{},
        success: function (data) {
            ...
            $("#table_stock_out_list").html(row);
			$('#table_stock_out_list').DataTable({
			    destroy: true,
