                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Stock In History</li>
...
$(document).ready(listStockTable);
function listStockTable(){
    
	$.ajax({
        url: '/load_stock_items_table',
        type: 'get',
        data:{},
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                row += '<tr><td style="display:none;">' + data[i].id + 
					'</td><td>' + data[i].stock_item_description +
					'</td><td>' + data[i].stock_item_no +
					'</td><td>' + data[i].stock_item_quantity +
					'</td><td>' + data[i].stock_item_date +
					'</td><td>' +"Rs.&nbsp" +data[i].stock_item_amount +
