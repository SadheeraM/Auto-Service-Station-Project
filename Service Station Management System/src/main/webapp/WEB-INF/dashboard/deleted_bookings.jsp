            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Deleted Bookings</h4>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Deleted Bookings List</li>
				...
				<div class="page">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							<table id="table_list1" class="table">
								<!--
							...
							<div class="card-body">
 							...
 							<a href="/adminPanel" class="btn btn-secondary" id="">&nbspBack&nbsp</a>
