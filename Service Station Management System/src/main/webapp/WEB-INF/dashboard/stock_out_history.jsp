            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Stock Out History</h4>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Stock Out History</li>
...
$(document).ready(listStockOutHistory);
function listStockOutHistory(){


    
	$.ajax({
        url: '/listAllSellingStockItems',
        type: 'get',
        data:{},
