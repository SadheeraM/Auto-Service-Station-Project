    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<input type="hidden" id="serviceType" name="serviceType" value="STOCK OUT BILL"/>
				<input type="hidden" id="isAccept" name="isAccept" value="1"/>
				<input type="hidden" id="isFinish" name="isFinish" value="1"/>
				<input type="hidden" id="datepicker-autoclose" name="date" value="">
				
				
				<button type="button" class="btn btn-success" onclick="sss()">&nbspSave&nbsp</button>
				<button type="button" class="btn btn-success" onclick="list_finish_jobs()">></button>
				...
				<div class="page">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							<table id="table_list_finish_Jobs" class="table">
...
$(document).ready(list_stock_out);
function list_stock_out(){
    
	$.ajax({
        url: '/list_stock_out_bills',
        type: 'get',
        data:{},
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                row += '<tr><td style="display:none;">' + data[i].id + 
					...
					'<a href="/stockOutInvoic" class="btn btn-success deleteBooking" id="deleteBtn" onclick="">' +
					'CHECKOUT</a>'+
                    '</td></tr>';
            }
            row += '</tbody>';
