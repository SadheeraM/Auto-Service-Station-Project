            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Stock Level</h4>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Stock Level</li>
				...
				<div class="page">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							<table id="stock_level" class="table">
								<!--
								<thead class="thead-dark">
									<tr>
										<th scope="col"><h6 align="center">Customer Name</h6></th>
										<th scope="col"><h6 align="center">Vehicle No</h6></th>
										<th scope="col"><h6 align="center">Type Of Vehicle</h6></th>
										<th scope="col"><h6 align="center">Service Type</h6></th>
										<th scope="col"><h6 align="center">Date</h6></th>
										<th scope="col"><h6 align="center">Time</h6></th>
										<th scope="col"><h6 align="center">********Action********</h6></th>
								...
								<tbody>
									...
									<c:forEach var="user" items="${employees}">
										<tr>
											...
											<td align="center">${user.typeOfVehicle}</td>
											...
											<input type="hidden" id="start_btn_id" value="${user.id}">
				
											
											<a href="/showFormForUpdate?employeeId=${user.id}" class="btn btn-success" id="aaa">
											...
											<input type="hidden" id="id12" value="${user.id}">
...
$(document).ready(listStockLevel);
function listStockLevel(){
    
	$.ajax({
        url: '/load_stock_items_levels',
        type: 'get',
        data:{},
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
				...
				if(data[i][3] <= 5){
					...
					var level = "<h6 id='min'>MINIMUM LEVEL</h6>";
					

				}else if(data[i][3] <= 25 ){

					var level = "<h6 id='reorder'>RE-ORDERING LEVEL</h6>";
					
				}else{

					var level = "<h6 id='max'>MAXIMUM LEVEL</h6>";
				}
                ...
                row += '<tr><td style="display:none;">' + data[i][0] + 
					...
					'</td><td>' + '<button type="button" id="'+data[i][1]+'" class="btn btn-success" onClick="reply_click(this.id)">Check</button>' +
...
function reply_click(clicked_id){
    ...
    var itemName = clicked_id;

	var xxx = loadStockInTotal(itemName);
	var yyy = loadSummaryQty(itemName);
	var level;
	...
	var quntity_Balance = xxx - yyy;
	
	var displyQty;
	
	if(isNaN(quntity_Balance)){

		displyQty = "There has been no reduction.";
	...
	swal({
		  ...
		  title: "STOCK LEVEL - " + level,
		  text: "No of Items - "+ displyQty,
		  icon: "",
		  buttons: true,
...
//$(document).ready(loadSummaryQty);
	function loadSummaryQty(itemName){
		
		var abc = itemName;
		var outputTotal;
	    
		$.ajax({
	        url: '/getTotalItemQty?theItemDes='+abc+'',
	        type: 'get',
	        async:false,
	        data:{},
	        success: function (data) {
...
function loadStockInTotal(itemName){
		
		var abc = itemName;
		var outputStockInTotal
	    
		$.ajax({
	        url: '/get_stock_in_total?theItemDes1='+abc+'',
	        type: 'get',
	        async:false,
	        data:{},
	        success: function (data) {
				
	        	outputStockInTotal = data;
	            
	        },
	        
	    });
			 return outputStockInTotal;
