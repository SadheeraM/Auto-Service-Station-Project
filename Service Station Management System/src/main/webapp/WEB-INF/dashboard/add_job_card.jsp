            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Add New Job Card</h4>
                        ...
                        <div class="card" style="height:70vh">
                            <div class="card-body">
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <input type="text" data-toggle="tooltip" title="Email address is optional !" class="form-control" id="email" 
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-success" onclick="addFormValidate()">&nbspSave&nbsp</button>
