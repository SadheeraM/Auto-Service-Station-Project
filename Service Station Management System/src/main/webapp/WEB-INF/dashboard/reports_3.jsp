            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Daily Income of the Service Station</h4>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Daily Income of the Service Station</li>
            ...
            <div class="page">
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							<table id="totalAmoutnOfServices" class="table">
            	...
            	<div class="page">
					<div class="card-body">
						...
						<input type="text" id="totalOFservices">
						<input type="text" id="datesOFtotalOFservices">
...
function getTotalAmounts(){
	...
	$.ajax({
        url: '/getTotalAmountOnlyServices?fromDate='+fromDate+'&toDate='+toDate+'',
        type: 'get',
        //async:false,
        data:{},
        ...
        success: function (data) {
            ...
            $("#totalAmoutnOfServices").html(row);
	...
	$.ajax({
        url: '/getTotalProfit?fromDate=04/01/2021&toDate=04/30/2021',
        type: 'get',
        async:false,
        data:{},
