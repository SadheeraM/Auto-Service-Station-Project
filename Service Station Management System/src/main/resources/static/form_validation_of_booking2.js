...
function inboxEditFormValidate() {
	...
	if (date !== '' && date >= check_date && date <= check_future_Month) {
		...
		$("#inbox_date_error_message").html("<i style='color:red;font-size: 0.9em'>The date you selected has already passed!</i>");
		$("#inbox_date_error_message").show();
		$("#datepicker-autoclose").css("border-bottom", "2px solid #F90A0A");
		error_date = true;
		...
		$("#inbox_date_error_message").html("<i style='color:red;font-size: 0.9em'>Please select a date within one month from today!</i>");
		$("#inbox_date_error_message").show();
		$("#datepicker-autoclose").css("border-bottom", "2px solid #F90A0A");
		error_date = true;	
	...
	*/
	...
	function check_time() {
		...
		if (time !== '' && !(date === check_date && start_Time < current_time)) {
			...
			$("#inbox_time_error_message").html("<i style='color:red;font-size: 0.9em'>Please select a time");
			$("#inbox_time_error_message").show();
			$("#edit_time").css("border-bottom", "2px solid #F90A0A");
			error_time = true;
		
		}else if(date === check_date && start_Time < current_time){
			$("#inbox_time_error_message").html("<i style='color:red;font-size: 0.9em'>This time has passed! Please check the current time");
			$("#inbox_time_error_message").show();
			$("#edit_time").css("border-bottom", "2px solid #F90A0A");
			error_time = true;	
		
		} else {
			$("#inbox_time_error_message").html("<i style='color:red;font-size: 0.9em'>Please select a valid time!");
			$("#inbox_time_error_message").show();
			$("#edit_time").css("border-bottom", "2px solid #F90A0A");
			error_time = true;
		}
